...
const ALLOWED_INVOKE = ["release:choose", "release:info", "release:net", "release:ping", "release:status", "release:pull", "release:push", "release:publish", "release:open-actions"];
